...
window.I18N = (function () {
  ...
  en:{
    ...
    'home.motion.cta':"See all the moves →",'home.story.cta':"Read the full story →",'home.story.cta.txt':"Read the full story",'home.story.hook':"Curious who Oddvi actually is?",'genesis.kicker':"Interactive",'genesis.h2':"How was Oddvi born?",'genesis.p':"It started as a circle. Scroll to watch — eyes, arms, legs, all joining in one by one.",'genesis.cta':"Watch the origin →",
  ...
  tr:{
    ...
    'home.motion.cta':"Tümünü Keşfet →",'home.story.cta':"Hikâyenin Devamı →",'home.story.cta.txt':"Hikâyenin Devamı",'home.story.hook':"Oddvi'yi gerçekten tanımak ister misin?",'genesis.kicker':"İnteraktif",'genesis.h2':"Oddvi nasıl doğdu?",'genesis.p':"Bir yuvarlaktan başladı. Kaydırarak izle — gözler, kollar, bacaklar, hepsi sırayla katıldı.",'genesis.cta':"Doğuşunu izle →",
  ...
  de:{
    ...
    'home.motion.cta':"Alle Moves ansehen →",'home.story.cta':"Die ganze Geschichte lesen →",'home.story.cta.txt':"Die ganze Geschichte lesen",'home.story.hook':"Neugierig, wer Oddvi wirklich ist?",'genesis.kicker':"Interaktiv",'genesis.h2':"Wie wurde Oddvi geboren?",'genesis.p':"Alles begann mit einem Kreis. Scroll und schau zu — Augen, Arme, Beine, alles kam nach und nach dazu.",'genesis.cta':"Die Entstehung ansehen →",
  ...
  fr:{
    ...
    'home.motion.cta':"Voir tous les moves →",'home.story.cta':"Lire l'histoire complète →",'home.story.cta.txt':"Lire l'histoire complète",'home.story.hook':"Curieux de savoir qui est vraiment Oddvi ?",'genesis.kicker':"Interactif",'genesis.h2':"Comment Oddvi est-il né ?",'genesis.p':"Tout a commencé par un cercle. Fais défiler pour voir — yeux, bras, jambes, tout s'est ajouté un par un.",'genesis.cta':"Voir la naissance →",
  ...
  hu:{
    ...
    'home.motion.cta':"Nézd meg az összes mozdulatot →",'home.story.cta':"Olvasd el a teljes történetet →",'home.story.cta.txt':"Olvasd el a teljes történetet",'home.story.hook':"Kíváncsi vagy, ki is valójában Oddvi?",'genesis.kicker':"Interaktív",'genesis.h2':"Hogyan született Oddvi?",'genesis.p':"Egy körrel kezdődött. Görgess és nézd végig — szemek, karok, lábak, minden sorban csatlakozott.",'genesis.cta':"Nézd meg a születését →",
  ...
  function pick(){
    // Explicit URL language prefix (/tr/, /de/, /fr/, /hu/) always wins — someone who typed or
    // clicked a link to /de/ wants German, even if a stale preference is sitting in localStorage.
    try{
...
window.I18N.quiz = {
 en:{
  ui:{home:"← Back home",eyebrow:"The Oddvi Test",intro:"Ten quick questions. One very specific kind of weird at the end — plus a wallpaper, a profile picture and your own Odd card to keep.",start:"Start the test →",qcount:"Question {n} of {total}",back:"← Back",youAre:"You are…",breakdownTitle:"Your Odd Breakdown",breakdownHint:"How your answers actually split across all six.",dlTitle:"Take your Odd with you",dlHint:"Four free downloads, made just for your result.",dlWallpaper:"Phone wallpaper",dlProfile:"Profile picture",dlCard:"Odd card",dlBreakdown:"Odd breakdown",download:"Download",share:"Share",building:"Building…",blocked:"Preview blocked here — works on the live site",retake:"↺ Retake the test",updates:"Get launch updates →",statLine:"{n} people have taken this test so far"},
  q:[
 ...
 tr:{
  ui:{home:"← Ana sayfa",eyebrow:"Oddvi Testi",intro:"On kısa soru. Sonunda sana çok özel bir tuhaflık türü — üstüne saklaman için bir duvar kağıdı, profil resmi ve kendi Odd kartın.",start:"Teste başla →",qcount:"Soru {n} / {total}",back:"← Geri",youAre:"Sen…",breakdownTitle:"Odd Dağılımın",breakdownHint:"Cevapların altı arketipe nasıl dağıldı.",dlTitle:"Odd'unu yanına al",dlHint:"Sonucuna özel dört ücretsiz indirme.",dlWallpaper:"Telefon duvar kağıdı",dlProfile:"Profil resmi",dlCard:"Odd kartı",dlBreakdown:"Odd dağılımı",download:"İndir",share:"Paylaş",building:"Hazırlanıyor…",blocked:"Önizlemede kısıtlı — canlı sitede çalışır",retake:"↺ Testi tekrar çöz",updates:"Lansman haberlerini al →",statLine:"Şimdiye kadar {n} kişi bu testi çözdü"},
  q:[
 ...
 de:{
  ui:{home:"← Zur Startseite",eyebrow:"Der Oddvi-Test",intro:"Zehn kurze Fragen. Am Ende eine ganz bestimmte Art von seltsam — plus ein Wallpaper, ein Profilbild und deine eigene Odd-Karte.",start:"Test starten →",qcount:"Frage {n} von {total}",back:"← Zurück",youAre:"Du bist…",breakdownTitle:"Deine Odd-Verteilung",breakdownHint:"So verteilen sich deine Antworten auf alle sechs.",dlTitle:"Nimm dein Odd mit",dlHint:"Vier kostenlose Downloads, nur für dein Ergebnis.",dlWallpaper:"Handy-Wallpaper",dlProfile:"Profilbild",dlCard:"Odd-Karte",dlBreakdown:"Odd-Verteilung",download:"Herunterladen",share:"Teilen",building:"Wird erstellt…",blocked:"Vorschau hier eingeschränkt — funktioniert auf der Live-Seite",retake:"↺ Test wiederholen",updates:"Launch-Updates erhalten →",statLine:"Bisher haben {n} Leute diesen Test gemacht"},
  q:[
 ...
 fr:{
  ui:{home:"← Accueil",eyebrow:"Le test Oddvi",intro:"Dix questions rapides. Une forme de bizarrerie bien précise à la fin — plus un fond d'écran, une photo de profil et ta propre carte Odd.",start:"Commencer le test →",qcount:"Question {n} sur {total}",back:"← Retour",youAre:"Tu es…",breakdownTitle:"Ta répartition Odd",breakdownHint:"Comment tes réponses se répartissent entre les six.",dlTitle:"Emporte ton Odd",dlHint:"Quatre téléchargements gratuits, faits pour ton résultat.",dlWallpaper:"Fond d'écran",dlProfile:"Photo de profil",dlCard:"Carte Odd",dlBreakdown:"Répartition Odd",download:"Télécharger",share:"Partager",building:"Création…",blocked:"Aperçu limité ici — fonctionne sur le site en ligne",retake:"↺ Refaire le test",updates:"Recevoir les actus du lancement →",statLine:"{n} personnes ont déjà fait ce test"},
  q:[
 ...
 hu:{
  ui:{home:"← Főoldal",eyebrow:"Az Oddvi-teszt",intro:"Tíz gyors kérdés. A végén egy nagyon konkrét furaság — plusz egy háttérkép, egy profilkép és a saját Odd-kártyád.",start:"Teszt indítása →",qcount:"{n}. kérdés / {total}",back:"← Vissza",youAre:"Te…",breakdownTitle:"A te Odd-eloszlásod",breakdownHint:"Így oszlanak meg a válaszaid mind a hat között.",dlTitle:"Vidd magaddal az Oddod",dlHint:"Négy ingyenes letöltés, kifejezetten az eredményedhez.",dlWallpaper:"Telefon háttérkép",dlProfile:"Profilkép",dlCard:"Odd-kártya",dlBreakdown:"Odd-eloszlás",download:"Letöltés",share:"Megosztás",building:"Készül…",blocked:"Az előnézet itt korlátozott — az élő oldalon működik",retake:"↺ Teszt újra",updates:"Hírek a megjelenésről →",statLine:"Eddig {n} ember csinálta meg ezt a tesztet"},
  q:[
